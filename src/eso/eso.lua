...
DIALOGUE_TONE_TYPE_KIND = 1
DIALOGUE_TONE_TYPE_GRIM = 2
DIALOGUE_TONE_TYPE_JOKER = 3
DIALOGUE_TONE_TYPE_FLIRTY = 4
DIALOGUE_TONE_TYPE_MERCIFUL = 5
DIALOGUE_TONE_TYPE_RUTHLESS = 6
